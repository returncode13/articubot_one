...
def generate_launch_description():
    ...
    world_dir=os.path.join(package_dir,'worlds')
    ...
    declare_world_cmd = DeclareLaunchArgument(
        ...
        default_value="/app/ros2_ws/src/worlds/aws-robomaker-small-warehouse-world/worlds/small_warehouse.world",
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(package_dir, 'config', 'multi_nav2.yaml'),
